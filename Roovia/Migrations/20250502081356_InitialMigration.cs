        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoSmallPath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LogoMediumPath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LogoLargePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchLogos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BranchLogos_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactNumbers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ContactNumbers_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ContactNumbers_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Emails_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchLogos_BranchId",
                table: "BranchLogos",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactNumbers_ApplicationUserId",
                table: "ContactNumbers",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactNumbers_BranchId",
                table: "ContactNumbers",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactNumbers_CompanyId",
                table: "ContactNumbers",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactNumbers_RelatedEntityType_RelatedEntityId_IsPrimary",
                table: "ContactNumbers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactNumbers_RelatedEntityType_RelatedEntityStringId_IsPrimary",
                table: "ContactNumbers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emails_RelatedEntityType_RelatedEntityId_IsPrimary",
                table: "Emails",
                columns: new[] { "RelatedEntityType", "RelatedEntityId", "IsPrimary" },
                unique: true,
                filter: "[IsPrimary] = 1 AND [RelatedEntityId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emails_RelatedEntityType_RelatedEntityStringId_IsPrimary",
                table: "Emails",
                columns: new[] { "RelatedEntityType", "RelatedEntityStringId", "IsPrimary" },
                unique: true,
                filter: "[IsPrimary] = 1 AND [RelatedEntityStringId] IS NOT NULL");
