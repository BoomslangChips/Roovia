...
namespace Roovia.Migrations
{
    ...
    [Migration("20250506125433_InitialMigration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Roovia.Models.Users.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Roovia.Models.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Roovia.Models.Users.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Roovia.Models.Users.UserPermissionOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Roovia.Models.Users.UserRoleAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Roovia.Models.Users.Branch", b =>
                {
                    ...
                    b.OwnsOne("Roovia.Models.Helper.BankAccount", "BankDetails", b1 =>
                        {
            ...
            modelBuilder.Entity("Roovia.Models.Users.RolePermission", b =>
                {
                    b.HasOne("Roovia.Models.Users.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Roovia.Models.Users.Role", "Role")
